...
static void gesture_judge(struct synaptics_ts_data *ts)
{
	...
	if ((gesture == DouTap && DouTap_gesture)
	    ...
	    || (gesture == Circle && Circle_gesture) || (gesture == DouSwip
							 && DouSwip_gesture)
	    || (gesture == DownVee && DownVee_gesture) || (gesture == Left2RightSwip
							   && Left2RightSwip_gesture)
	    || (gesture == Right2LeftSwip && Right2LeftSwip_gesture) || (gesture == Up2DownSwip
									 && Up2DownSwip_gesture)
...
static void tp_gesture_set_enable(void) {
	...
	TPD_DEBUG
	    ("gesture suport LeftVee:%d RightVee:%d DouSwip:%d Circle:%d UpVee:%d DouTap:%d DownVee:%d Left2RightSwip:%d Right2LeftSwip:%d Up2DownSwip:%d Down2UpSwip:%d\n",
	    LeftVee_gesture, RightVee_gesture, DouSwip_gesture, Circle_gesture,
	    UpVee_gesture, DouTap_gesture, DownVee_gesture, Left2RightSwip_gesture,
	    Right2LeftSwip_gesture, Up2DownSwip_gesture, Down2UpSwip_gesture);
	...
	if (DouTap_gesture || Circle_gesture || UpVee_gesture
	    ...
	    || DownVee_gesture || Left2RightSwip_gesture || Right2LeftSwip_gesture
	    || Up2DownSwip_gesture || Down2UpSwip_gesture)
	{
		ts->gesture_enable = 1;
	}
	else
