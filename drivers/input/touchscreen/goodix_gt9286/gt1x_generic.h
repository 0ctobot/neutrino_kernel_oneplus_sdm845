...
extern int es_enabled;
extern int ear_flag;
extern int es_touch_count;
#endif
...
extern int tp_detect_flag;

extern int GTP_DEBUG_ON;

extern int GTP_DEBUG_ARRAY_ON;

extern int GTP_DEBUG_FUNC_ON;

#ifdef CONFIG_GTP_TOUCH_DETECT
extern int touch_detect_flag;
extern s32 touch_rowdata_event_handler(struct input_dev * dev);
extern void gt1x_touch_detect_switch(s32 on);
#endif
